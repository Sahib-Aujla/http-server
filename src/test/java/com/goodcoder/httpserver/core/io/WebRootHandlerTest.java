...
public class WebRootHandlerTest {
    ...
    void constructorGoodPath() {
        try {
            WebRootHandler webRootHandler = new WebRootHandler("C:\\Users\\sahib\\webdev\\httpserver\\WebRoot");
    ...
    void constructorBadPath() {
        try {
            WebRootHandler webRootHandler = new WebRootHandler("C:\\Users\\sahib\\webdev\\httpserver\\WebRoot2");
            fail();
        } catch (WebRootNotFoundException e) {
        }
    }
    ...
    void testGetFileMimeTypeText() {
        try {
            String mimeType = webRootHandler.getFileMimePath("/");
